export type UserRole = 'owner' | 'head_coach' | 'assistant_coach' | 'player' | 'administrator' | 'media' | 'medical' | 'scout' | 'parent' | 'guest'
...
export type EventType = 'training' | 'match' | 'meeting' | 'camp' | 'other' | 'assessment' | 'education'
export type LeaveStatus = 'pending' | 'approved' | 'rejected' | 'partial'
export type AdminDecisionType = 'suspension' | 'national_team' | 'penalty' | 'rest' | 'emergency' | 'death' | 'marriage' | 'academic' | 'family' | 'private_event' | 'other'
